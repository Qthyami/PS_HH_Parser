...
namespace PSHhParser
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            //можно попробовать на 1 раздаче, а можно закомментив 2 строки ниже и раскомментив закомменченный код вставить путь txt файла с раздачей, чтобы перепарсить много раздач.
            ...
            //var hands = (@"C:\MyHandsArchive_H2N\2025\8\12\Impala IV.txt"); //вставить свой путь

            //var newText = PsHhReader.ReadHands(hands);
            //foreach (var hand in newText)
            //{
            //    PSHandParser.ParseHand(hand);
            //}
